...
public class VclipToCommand extends Command {
    public VclipToCommand() {
        super("vclipto", "Lets you clip through blocks vertically.");
    }

    @Override
    public void build(LiteralArgumentBuilder<CommandSource> builder) {
        builder.then(argument("height", DoubleArgumentType.doubleArg()).executes(context -> {

            double blocks = context.getArgument("height", Double.class) - mc.player.getY();
